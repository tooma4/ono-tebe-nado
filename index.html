...
<html lang="ru">
  ...
  <body>
    ...
    <main>
      <section class="cover">
        <div class="overlay overlay__cover"></div>
        <h1 class="cover__title">
          <span class="aligned-text"
            >О<span class="letter-spacing-extended">н</span>о</span
          >
          <span class="aligned-text_center"
            >те<span class="letter-spacing-extended">б</span>e</span
          ><span class="aligned-text_right"
            ><span class="no-letter-spacing">н</span>адо</span
          >
        </h1>
            ...
            <a class="card-link" href="#0">
              <article class="card">
                <div class="card_type_film">
                  ...
                  <div class="overlay overlay__lots"></div>
                </div>
              </article>
            </a>
          </li>
        ...
        <div class="about__column">
          ...
          <div class="about__title-text">
            ...
            <div class="about__text-group">
              ...
              <p class="about__text about__text-part-two">
                ...
                <br />на критику, кажущуюся простоту или сложность, сейчас без
                этих лотов невозможно представить современную культуру. Когда в
